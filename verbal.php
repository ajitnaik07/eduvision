        ...
        <ul class="clearfix">
            ...
            <li class="current-item">
				...
				<ul class="sub-menu">
                    ...
                    <li class="current-item"><a href="verbal.php">Verbal</a></li>
...
<li><a href="1_Intro_to_No_Shift_Sentences.mp4">Text Completion - No Shifts</li>
<li><a href="1_Intro_to_Sentence_Shifts.mp4">Text Completion - Sentence Shifts</li>
<li><a href="1_Intro_to_Double_Blank_Sentences.mp4">Text Completion - Double Blank</li>
<li><a href="1_Intro_to_Triple_Blank_Sentences.mp4">Text Completion - Triple Banks</li>
<li><a href="1_Intro_to_Sentence_Equivalence.mp4">Sentence Equivalence</li>
<li><a href="1_Intro_to_Reading_Comprehension.mp4">Reading Comprehension</li>
</ul>
</div>
<br>
