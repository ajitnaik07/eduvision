        ...
        <ul class="clearfix">
            ...
            <li class="current-item">
				...
				<ul class="sub-menu">
					...
					<li  class="current-item"><a href="awa.php">AWA</a></li>
                </ul>
			</li>
			<li>
...
<li><a href="1_Intro_to_AWA">AWA Basics</li>
<li><a href="1_Intro_to_Issue_Task">Issue Task</li>
<li><a href="1_Intro_to_Argument_Task">Argument Task</li>
</ul>
</div>
<br>
